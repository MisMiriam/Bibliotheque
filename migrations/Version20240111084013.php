 ...
 */
final class Version20240111084013 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE livre DROP nom_categorie');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE livre ADD nom_categorie VARCHAR(255) DEFAULT NULL');
    }
}
